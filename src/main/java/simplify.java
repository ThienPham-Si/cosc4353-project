...
// ((2.0 * x) + (6.0 * x)) => (8.0 * x)
        System.out.println("Before Simplify:" + new Plus(new Mult(2, "x"), String.valueOf(new Mult(6, "x"))));
        System.out.println("After Simplify:" + new Plus(new Mult(2, "x"), String.valueOf(new Mult(6, "x"))).
                advancedSimplify());
        System.out.println("-----");
// ((2.0 * x) + (x * 6.0)) => (8.0 * x)
        System.out.println("Before Simplify:" + new Plus(new Mult(2, "x"), String.valueOf(new Mult("x", 6))));
        System.out.println("After Simplify:" + new Plus(new Mult(2, "x"), String.valueOf(new Mult("x", 6))).
                advancedSimplify());
        System.out.println("-----");
// ((x * 2.0) + (6.0 * x)) => (8.0 * x)
        System.out.println("Before Simplify:" + new Plus(new Mult("x", 2), String.valueOf(new Mult(6, "x"))));
        System.out.println("After Simplify:" + new Plus(new Mult("x", 2), String.valueOf(new Mult(6, "x"))).
                advancedSimplify());
        System.out.println("-----");
// ((x * 2.0) + (x * 6.0)) => (8.0 * x)
        System.out.println("Before Simplify:" + new Plus(new Mult("x", 2), String.valueOf(new Mult("x", 6))));
        System.out.println("After Simplify:" + new Plus(new Mult("x", 2), String.valueOf(new Mult("x", 6))).
                advancedSimplify());
        System.out.println("-----");
// (((x + y) * 2.0) + ((x + y) * 5.0)) => (7.0 * (x + y))
        System.out.println("Before Simplify:" + new Plus(new Mult(new Plus("x", "y"), 2),
                String.valueOf(new Mult(new Plus("x", "y"), 5))));
        System.out.println("After Simplify:" + new Plus(new Mult(new Plus("x", "y"), 2),
                String.valueOf(new Mult(new Plus("x", "y"), 5))).advancedSimplify());
        System.out.println("-----");
...
// ((5.0 + -(5.0)) / (y + x)) => 0.0
        System.out.println("Before Simplify:" + new Div(new Plus(String.valueOf(5), new Neg(5)), new Plus("y", "x")));
        System.out.println("After Simplify:" + new Div(new Plus(String.valueOf(5), new Neg(5)), new Plus("y", "x")).advancedSimplify());
        System.out.println("-----");
    }
}